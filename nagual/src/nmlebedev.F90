...
contains
  ...
  implicit none
    ...
    select case (np)
      ...
      case default
        call file_error('Unknown Lebedev grid requested')
    end select
  end subroutine

  ! Below this point the LEBEDEVS are found, read the
  ! following information before using this software for other purposes
  ! Roberto Flores-Moreno, Aug 2008

!====================================================
!
!   The routines contained in this module generate
!   Lebedev grids [1-6] for integration on a sphere. 
!   With exception of the driver "lebedev", the original 
...
!points generated. All these routines need the subroutine gen_oh which takes care 
...
!cvw
       ...
       call file_error('Gen_Oh: Invalid Code') ! Proper connection with Nagual
    1  continue
       a=1.0d0
       x(1) =  a
       y(1) =  0.0d0
